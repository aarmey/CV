...
4. Bae, S.Y., N. Guan, R. Yan, K. Warner, **A.S. Meyer**. (2020). Measurement and models accounting for cell death capture hidden variation in compound response. _Cell Death & Disease_, _Accepted._

### Therapeutic resistance and design

The benefits cancer patients derive from targeted therapies are limited by genetic and non-genetic mechanisms of resistance. This is in part due to an incomplete understanding of the many compensatory molecular changes that occur when one treats with a therapy. We have developed a variety of combined computational/experimental strategies to better understand how drug resistance arises.
