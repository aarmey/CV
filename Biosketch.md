...
I have a background in biological engineering with training in applied machine learning, cell signaling, and pharmacodynamics. My research broadly applies integrated experimental and theoretical approaches to study the complex signaling that underlies cell-to-cell communication and signaling responses to perturbation. My lab is particularly interested in how signaling cues operate in combination to direct cancer and immune effector cell behavior and how we might optimally target their dysregulation. For example, my previous work has shown how (1) to use a pharmacodynamic model of IL-2 signaling across cell populations to engineer cell-specific cytokines, (2) IgG antibody effector function is transduced through multiple receptors and effector cells, (3) multi-modal dimensionality techniques can improve interpretation of high-throughput serology measurements, and (4) an RTK family expressed in cancer and innate immune cells is activated in response to extracellular cues in the tumor microenvironment.
...
Studying complex signaling requires approaches tailored to the biologic system and scientific challenge at hand. We have implemented, extended, and developed a wide range of mathematical and computational methods to provide new views of cell signaling mechanisms. For example, in (1) we demonstrated how tensor factorization can help to visualize the multi-dimensional response of the common gamma chain receptor cytokine family. More recently, we have extended this approach of multi-modal analysis to high-throughput serology measurements (2). Here, we show that multi-modal analysis offers more effective dimensionality reduction, improving model interpretation without reductions in our ability to predict antibody-mediated protection. A focus of our group has been effective integration of data-driven and mechanistic modeling techniques to leverage the strengths of each approach (1, 3, 4). In (3) we uncovered that the TAM receptor family senses local clusters of ligand, and used a partial differential equation model to explore this process. Finally, we have used Bayesian inference techniques of increasing scalability to perform rigorous parameterization of our models of interest (1, 3, 4).

1. Farhat, A.M., A.C. Weiner, C. Posner, Z.S. Kim, B. Orcutt-Jahns, S.M. Carlson, **A.S. Meyer**. (2021). Modeling Cell-Specific Dynamics and Regulation of the Common Gamma Chain Cytokines. _Cell Reports._ 35, 109044. PMID: 33910015.
2. Murphy, M., S.D. Taylor, **A.S. Meyer**. Structured decomposition improves systems serology prediction and interpretation. _bioRXiv._ 2021.01.03.425138 [Preprint].
