...
I have a background in biological engineering, with training in applied machine learning, cell signaling, and cancer. My research broadly applies integrated experimental and theoretical approaches to understanding the complex signaling that underlies tumor invasion and resistance. My lab is particularly interested in how cues operate in combination within the tumor microenvironment to direct cancer cell behavior and how we might optimally target this dysregulation. For example, my previous work has shown how proteolytic receptor turnover provides resistance-promoting feedback (4), receptor crosstalk is a mechanism of signal diversification promoting breast tumor invasion (3), bypass resistance to therapy operates through coordinated pathway activation (2), and ECM environments interact with drug treatment to influence cell response (1). In particular, this latter study (1) lays the groundwork for the analysis we will perform in Aim 3. My lab will lead the studies outlined in Aim 3 and help integrate these results with the efforts outlined elsewhere. This work exactly aligns with my lab's interests and capabilities—our success identifying a broader set of drug combinations that effectively manipulate plasticity will rely on our experimental and computational expertise.

While early in my independent career, I have served as PI on a number of grants and supervised technicians, graduate students, and postdoctoral associates. My lab has a long-standing, active collaboration with the Heiser, Levy, Peyton, and Qing labs, and we are in frequent contact. Indeed, a recent publication (1) from my and the Peyton lab reflects our productive collaboration.

1. Schwartz, A.D., L.E. Barney, L.E. Jansen, T.V. Nguyen, C.L. Hall, **A.S. Meyer**, S. Peyton. A Biomaterial Screening Approach to Reveal Microenvironmental Mechanisms of Drug Resistance. _Integrative Biology_, 2017 (In press).
2. Manole, S., E.J. Richards, **A.S. Meyer**. JNK pathway activation modulates acquired resistance to EGFR/HER2 targeted therapies. _Cancer Research._ 2016 Sept 15; 76 (18): 5219-5228. PMCID: 5026573.
...
4. Schwartz, A.D., L.E. Barney, L.E. Jansen, T.V. Nguyen, C.L. Hall, **A.S. Meyer**, S. Peyton. A Biomaterial Screening Approach to Reveal Microenvironmental Mechanisms of Drug Resistance. _Integrative Biology_, 2017 (In press).
